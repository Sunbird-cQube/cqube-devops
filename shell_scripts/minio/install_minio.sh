...
if ! [ $( docker ps -a | grep cqube_minio | wc -l ) -gt 0 ]; then
   ...
   docker run -p 9000:9000 -p 9001:9001 --name cqube_minio --restart=always --network cqube_net --ip 172.20.0.2 -d minio/minio:latest server /data --console-address ":9001"
